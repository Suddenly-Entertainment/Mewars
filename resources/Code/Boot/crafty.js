...
(function(window, initComponents, undefined) {
    ...
    var Crafty = function(selector) {
        ...
        GUID, FPS, frame, components, entities, handlers, onloads, tick, requestID, noSetter, loops, milliSecPerFrame, nextGameTick, slice, rlist, rspace,
...
function(Crafty, window, document) {
    ...
    Crafty.c("WiredHitBox", {
        ...
        init: function() {
            ...
            if(Crafty.support.canvas) {
                ...
                var drawed = 0,
                    total = Crafty("WiredHitBox").length;
    ...
    Crafty.c("SolidHitBox", {
        init: function() {
            if(Crafty.support.canvas) {
                ...
                var ctx = c.getContext('2d');
                var drawed = 0,
                    total = Crafty("SolidHitBox").length;
                this.requires("Collision").bind("EnterFrame", function() {
                    if(drawed == total) {
                        ctx.clearRect(0, 0, Crafty.viewport.width, Crafty.viewport.height);
                        drawed = 0;
    ...
    Crafty.extend({
        ...
        keyboardDispatch: function(e) {
            ...
            //if there is an active imput element however we want to allow thouse key presses
    ...
    Crafty.c("Particles", {
        ...
        _Particles: {
            ...
            initParticle: function(particle) {
                ...
                var start = [
                this.startColour[0] + this.startColourRandom[0] * this.RANDM1TO1(), this.startColour[1] + this.startColourRandom[1] * this.RANDM1TO1(), this.startColour[2] + this.startColourRandom[2] * this.RANDM1TO1(), this.startColour[3] + this.startColourRandom[3] * this.RANDM1TO1()];

                var end = [
                this.endColour[0] + this.endColourRandom[0] * this.RANDM1TO1(), this.endColour[1] + this.endColourRandom[1] * this.RANDM1TO1(), this.endColour[2] + this.endColourRandom[2] * this.RANDM1TO1(), this.endColour[3] + this.endColourRandom[3] * this.RANDM1TO1()];
    ...
    Crafty.extend({
        ...
        modules: function(modulesRepository, moduleMap, oncomplete) {
            ...
            for(var i in moduleMap) {
                if(validBase.test(i)) modules.push(i)
                else modules.push(modulesRepository + '/' + i.toLowerCase() + '-' + moduleMap[i].toLowerCase() + '.js');
            }
