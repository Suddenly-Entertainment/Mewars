...
$MEW.LoadResources = function (progress_cb){
	...
	// Tile image names
	var TileImageNames = [
		'apple_trees_block.png', 'desert_2_block.png', 'everfree_forest_block.png', 'forest_block.png', 'ice_block.png', 
	...
	var SpriteImageNames = [
		'ARMOROPT.PNG', 'COLOURS.PNG', 'COLOURSBLACK.png', 'EYES.png', 'HAIRFEM.png',
	...
	var InterfaceImageNames = [
		'world_map_concept_mysticalpha-800.jpg', 'silouhetteavatar.png', 'anonavatar.png', 'anonavatar1.png', 
		'ParchmentWSV.png'
	];
...
$MEW.setupInterfaces = function () {
    ...
    Crafty.sprite(800, 600, InterfaceResourceURL + 'world_map_concept_mysticalpha-800.jpg', {WorldMapConcept: [0, 0]});
